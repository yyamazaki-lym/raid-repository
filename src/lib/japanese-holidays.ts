 ...
 *      back to a hardcoded table covering 2024 〜 2030 so the UI doesn't
 *      lose holiday colors entirely. ※ 最新年 +2 年程度を毎年補充する運用
 *      (この表は degraded 経路専用。primary はライブ API で自動更新される)。
 *
