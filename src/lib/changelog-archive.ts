...
export const RELEASES_ARCHIVE: ReleaseEntry[] = [
  {
    ...
    parts: [
      ...
      {
        title:
          "🩹 出席サマリーが同期式で「取得に失敗しました」になっていたのを修正"
      },
      {
        title:
          "📄 攻略リンクに貼った Google スプレッドシート / ドキュメントを、白い画像ではなく種類が分かるカードで表示"
      },
      {
        title:
          "🙋 自分のページの見た目を他のページと揃え、BiS と学習パスの進み具合をバーで表示"
      },
    ],
  },
  {
    ...
    parts: [
      ...
      {
        title: "🔗 練習ログ: 層 / フェーズの絞り込みを 1 段のセグメントに + 選択を URL で共有 / 軽減表の層タブをシート表示でも使えるように",
      },
      {
        title: "🟩 練習ログ: 日ごとの「プル・ボックス列」(1 pull = 1 小箱) / コンテンツカードに直近 8 週の到達度スパークライン",
      },
      {
        title: "🗓 定期枠 (毎週 X 曜) を設定できるように / 期間 + 曜日で候補日を一括生成 / 枠から外れた日に「臨時」「今回だけ」",
      },
      {
        title: "🐛 設定ダイアログの操作が無言でできなくなっていたのを修正 (「レポートの発見元が変更できない」の原因)",
      },
      {
        title: "🔀 練習ログ: レポートの自動発見を「経路ごとの ON/OFF」に (guild と自分のアカウントを同時に ON できる)",
      },
      {
        title: "🗂 設定: 長い節を折りたたみ式に (開閉は端末ごとに記憶)",
      },
      {
        title: "🟩 練習ログ: プル・ボックス列の仕上げ (色を弱める / 討伐マークの縦揃え / 飛んだ先を光らせる)",
      },
      {
        title: "📏 練習ログ: pull 行が 2 行に折り返さないように (DPS はクリア時のみ / 技名は可変幅 / 動画チップを 1 グループに)",
      },
      {
        title: "📈 練習ログ: 進行トレンドに到達度の目盛り・期間・凡例を追加 (薄い線と濃い線の意味を明記)",
      },
      {
      ...
      {
        title: "🙋 予定表: 日ごとに「有志練習 (任意参加)」を付けられるように (自動確定・未回答の催促・出席の集計から外れる)",
      },
      {
        title: "🧾 出席の自動突合の土台: ログに映っていた人をメンバーに紐づける (キャラクター名は保存しない)",
      },
      {
        title: "🗒 出席サマリー: 回答 (○×△) とログの突合を予定表から見られるように (本人は自分の分 / 幹部は全員)",
      },
      {
      ...
      {
        title: "🩺 練習ログ: 死亡時点の HP / シールド / かかっていた効果を FFLogs から読めるように (押したときだけ取得)",
      },
      {
        title: "🎲 ロット: 部位ごとの「欲しい人」行列と取る順番の提案 (BiS の取得済から自動 / 確定はしない)",
      },
      {
        title: "⭐ マクロ: 「採用中」の印と、採用中との差分の行数 (複数の strat が並んでも「うちはどれか」が分かる)",
      },
      {
        title: "📱 予定表: スマホは縦のアジェンダ表示に (横スクロールなしで「次はいつか」と自分の回答が見える)",
      },
      {
        title: "🛡 軽減表: カードの絞り込みを「全部 / 自分のロール / 自分の担当だけ」の 3 段に (メンバーにロールを設定)",
      },
      {
        title: "📋 練習ログ: pull からボスの大きい技を拾って軽減表の雛形を作れるように (Sheets に貼れる形でコピー)",
      },
      {
        title: "🎓 攻略情報: 新規メンバー向けの学習パス (動画 → 散開図 → マクロ → 軽減表 の順序付きチェックリスト)",
      },
      {
        title: "🙋 自分のページ (/me): 残り BiS・学習パス・出席を 1 枚に (コマンドパレットから開けます)",
      },
      {
        title: "🌐 練習ログ: ワイプ原因とボスの技名を表示言語で出す (英語のまま残っていた過去の pull も含む)",
      },
      {
        title: "🎭 軽減表: 自分のジョブを設定すると「自分のロール / 自分の担当だけ」が使えるように (ロールはジョブから決まります)",
      },
    ],
  },
  {
    ...
    parts: [
      ...
      {
        title: "🌐 表示言語の切替 (日本語 / English) — 第 1 段: ログイン / ヘッダー / スケジュール画面",
      },
      {
        title: "🐛 練習ログ: 絶竜詩戦争のレポートがカテゴリに紐づかなかったのを修正 / 空状態の文章を中央揃えに",
      },
      {
        title: "🌐 表示言語 第 2 段: 出欠 popover / 候補日 / 時刻編集 / メモ / 凡例 / FFLogs リンク / 募集テンプレートなどスケジュール周辺を日英化",
      },
    ],
  },
  {
