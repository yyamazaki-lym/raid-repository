...
export const DECISION_BADGE_CLASS =
  ...
  "inline-flex h-6 shrink-0 items-center justify-center rounded-md border border-emerald-400/70 bg-emerald-400/18 px-2 text-[11px] font-bold tracking-normal whitespace-nowrap text-emerald-300 shadow-[0_0_12px_-3px_rgba(52,211,153,0.55)]";
