...
export const ja = {
  logs: {
    ...
    // UI-5 (2026-09-08): 区間の絞り込みセグメント。選択は URL に載る。
    floorFilterAria: "層で絞り込む",
    floorFilterAllTitle: "すべての層の pull を表示 (URL の ?floor= を外す)",
    phaseFilterAria: "フェーズで絞り込む",
    phaseFilterAllTitle: "すべてのフェーズの pull を表示 (URL の ?phase= を外す)",
    phaseFilterTitle: (phase: number) => `P${phase} まで到達した pull だけ表示`,
    ...
    pullNoteSelfMark: "●",
    pullNoteTagAria: "注釈のタグ",
    pullNotePlaceholder: "一言 (任意)",
    pullNoteTags: {
      "aoe-hit": "AoE 被弾",
      "mit-missing": "軽減不足",
      "switch-late": "スイッチ遅れ",
      ...
      knockback: "ノックバック",
      "add-handling": "雑魚処理",
      "heal-timing": "回復が間に合わず",
      "call-missed": "コール漏れ",
      downtime: "火力不足 / 時間切れ",
      other: "その他",
    },
    // 傾向カード + Discord 用の本文。
    pullNoteTrendTitle: "ミス注釈の傾向",
    pullNoteTrendSubtitle: (n: number): string => `チーム帰属 ${n} 件`,
    pullNoteTrendEmpty:
      "まだ注釈がありません。pull の番号を押して開くと、その pull に注釈を付けられます。",
    pullNoteTrendTruncated: "直近 400 件まで",
    pullNoteDigestCopy: "振り返りをコピー",
    pullNoteDigestCopied: "振り返りをコピーしました (Discord に貼れます)",
...
export const en: LogsMessages = {
  logs: {
    ...
    floorFilterAria: "Filter by floor",
    floorFilterAllTitle: "Show pulls from every floor (drops ?floor= from the URL)",
    phaseFilterAria: "Filter by phase",
    phaseFilterAllTitle: "Show pulls from every phase (drops ?phase= from the URL)",
    phaseFilterTitle: (phase) => `Show only pulls that reached P${phase}`,
    floorShort: (n) => `F${n}`,
    ...
    pullNoteSelfMark: "●",
    pullNoteTagAria: "Note tag",
    pullNotePlaceholder: "One line (optional)",
    pullNoteTags: {
      "aoe-hit": "Took an AoE",
      "mit-missing": "Missing mitigation",
      "switch-late": "Late swap",
      position: "Spread / position",
      knockback: "Knockback",
      "add-handling": "Add handling",
      "heal-timing": "Heal too late",
      "call-missed": "Missed call",
      downtime: "Damage / timer",
      other: "Other",
    },
    pullNoteTrendTitle: "Mistake notes",
    pullNoteTrendSubtitle: (n) => `${n} team note(s)`,
    pullNoteTrendEmpty:
      "No notes yet. Click a pull number to open it and add notes there.",
    pullNoteTrendTruncated: "latest 400",
    pullNoteDigestCopy: "Copy recap",
    pullNoteDigestCopied: "Recap copied (paste it into Discord)",
