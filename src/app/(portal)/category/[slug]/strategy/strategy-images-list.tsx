          ...
          >
            ...
            {hasMultiple && (
              <>
                ...
                <span
                  aria-hidden
                  className="absolute bottom-3 left-1/2 -translate-x-1/2 rounded-full bg-black/50 px-3 py-1 font-mono text-[11px] tracking-[0.18em] text-white/70 uppercase"
                >
                  {idx + 1} / {links.length}
                </span>
              </>
        ...
        <div className="flex items-center gap-1.5">
          {shareHref && (
            <a
              ...
              className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] tracking-normal text-muted-foreground transition-colors hover:bg-secondary/50 hover:text-foreground"
            >
          ...
          <Button
            ...
            onClick={onDelete}
            disabled={deleting}
            className="gap-1 text-[11px] tracking-normal text-destructive hover:text-destructive"
          >
